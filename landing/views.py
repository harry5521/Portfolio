...
from .models import Profile, Contact, Project, Skill, Experience, Certification, Technology
...
class LandingView(FormView):
    ...
    def form_valid(self, form):
        ...
        subject = form.cleaned_data.get('subject', 'Portfolio Contact')
        ...
        # Get profile for sender email
        try:
            profile = Profile.objects.first()
            sender_email = profile.email if profile and profile.email else 'hurairagulfaraz4@gmail.com'
        except:
...
"""
        ...
        messages.success(self.request, 'Your message has been sent successfully! I\'ll get back to you soon.')
